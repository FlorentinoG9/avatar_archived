...
### Changed
- Update file structure (#22)(readme) (d93303c)

## [4.0.0] - 2025-10-31

### Changed
- Pre commits (#21) [BREAKING CHANGE] (459a688)
- Pre commits (#20) (5b45216)

## [3.1.3] - 2025-10-30

### Changed
- Move sftp.py to transfer-data module (#19)(transfer-data) (342011c)

## [3.1.2] - 2025-10-30

### Changed
- Reorganize ml architecture into parent ml/ directory (#18)(ml) (e872c8d)

## [3.1.1] - 2025-10-30

### Changed
- Move plotscode under brainwaves_visualization folder (#17)(plots) (6829a32)

## [3.1.0] - 2025-10-30

### Added
- Build charts dynamically (#16)(developer_charts) (1547798)

## [3.0.0] - 2025-10-30

### Changed
- Release version naming convention "vx.y.z" (#15) [BREAKING CHANGE] (4bc2f03)

## [2.0.1] - 2025-10-30

### Changed
- Breaking change: release v2.0.0 change interface (#14) (bd190c9)
- Refactor/gui (#12) (606965c)
- Revert "execute button fix issue: #442" (dc8ff92)
- Revert "add access_data.txt placeholder under file-opendata/brainwaves" (5e98d44)
- Access_data.txt placeholder under file-opendata/brainwaves (384d426)
- Add access_data.txt placeholder under file-opendata/brainwavesclear (19f884a)
- Add access_data.txt placeholder under file-opendata/brainwaves (3ac9b55)
- Add access_data.txt placeholder under file-opendata/brainwaves (58ce4d0)
- Revert "execute button fix issue: #442" (226003f)
- Revert "add access_data.txt placeholder under file-opendata/brainwaves" (4c9f738)
- Access_data.txt placeholder under file-opendata/brainwaves (802b70c)
- Add access_data.txt placeholder under file-opendata/brainwavesclear (d0e6d33)
- Add access_data.txt placeholder under file-opendata/brainwaves (65870c4)
- Add access_data.txt placeholder under file-opendata/brainwaves (639611c)
- Fix typo in move_left function call (018eb88)
- Add the button functionality #450 (c2b1262)
- Fixes manual drone control crashing for linux. (91b8619)
...
### Changed
- Squashed commit of the following: (8f9b4b2)

## [1.1.4] - 2025-10-29

### Changed
- Refactor/dynamic devs charts (#13) (6f69224)

## [1.1.3] - 2025-10-28

### Changed
- Refactor/gui (#12) (948b5ab)
