...
- **EEG Data Streaming**: Real-time brainwave data from the Avatar GUI to ML prediction services
...
1. **eeg-brainwave-data**: Streams EEG data from OpenBCI headset via Avatar GUI
...
### Avatar GUI Integration
Replace direct HTTP calls to prediction service with Kafka producers in `gui/v5/backend.py`:
