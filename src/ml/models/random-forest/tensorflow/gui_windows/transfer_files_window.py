...
# Note: optionxform is a method that can be overridden to make keys case-sensitive
config.optionxform = lambda option: str(option)  # type: ignore[assignment,method-assign]
