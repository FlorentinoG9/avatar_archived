...
class Drone_Control:
    ...
    def manual_drone_control_window(self, get_drone_action):
        ...
        top_center = [
            [
                sg.Button(
                    ...
                    expand_x=True,
                    expand_y=True,
                    image_filename="GUI_Pics/up.png",
                )
            ]
        ]
        top_right = [
            [sg.Text("Flight Log")],
            [sg.Listbox(values=[], size=(40, 5), key="LOG")],
        ]
        bottom_center = [
            [
                sg.Button(
                    ...
                    expand_x=True,
                    expand_y=True,
                    image_filename="GUI_Pics/down.png",
                )
            ]
        ]
        ...
        manual_drone_control_layout = [
            [
                sg.Button("Home", size=(8, 2), image_filename="GUI_Pics/home.png"),
                sg.Column(
                    top_center, expand_x=True, expand_y=True, pad=((0, 0), (0, 0))
                ),
                sg.Column(top_right),
            ],
            # [sg.Push(), sg.Push(), sg.Button('Forward', size=(8, 2),  expand_x=True, expand_y=True,
            # image_filename="GUI_Pics/Forward.png"), sg.Push(), sg.Push(),],
            [
                sg.Button(
                    "Forward",
                    size=(8, 2),
                    expand_x=True,
                    expand_y=True,
                    image_filename="GUI_Pics/Forward.png",
                )
            ],
            [
                sg.Button(
                    ...
                    expand_x=True,
                    expand_y=True,
                    image_filename="GUI_Pics/turnLeft.png",
                ),
                sg.Button(
                    "Left",
                    size=(8, 2),
                    expand_x=True,
                    expand_y=True,
                    image_filename="GUI_Pics/left.png",
                ),
                sg.Button(
                    "Stream",
                    expand_x=True,
                    expand_y=True,
                    image_filename="GUI_Pics/drone.png",
                ),
                sg.Button(
                    "Right",
                    size=(8, 2),
                    expand_x=True,
                    expand_y=True,
                    image_filename="GUI_Pics/right.png",
                ),
                sg.Button(
                    "Turn Right",
                    size=(8, 2),
                    expand_x=True,
                    expand_y=True,
                    image_filename="GUI_Pics/turnRight.png",
                ),
            ],
            [
                sg.Button(
                    ...
                    expand_x=True,
                    expand_y=True,
                    image_filename="GUI_Pics/back.png",
                )
            ],
            [
                sg.Button(
                    "Connect1", size=(8, 2), image_filename="GUI_Pics/connect.png"
                ),
                sg.Column(
                    bottom_center, expand_x=True, expand_y=True, pad=((0, 0), (0, 0))
                ),
                sg.Button(
                    "Takeoff", size=(8, 2), image_filename="GUI_Pics/takeoff.png"
                ),
                sg.Button("Land", size=(8, 2), image_filename="GUI_Pics/land.png"),
            ],
        ]
