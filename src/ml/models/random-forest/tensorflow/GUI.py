...
brainwave_tab = brainwaveObj.brainwave_prediction_window(
    get_drone_action, use_brainflow
)
...
while True:
    ...
    try:
        if event1 == sg.WIN_CLOSED:
            ...
            brainwaveObj.buttonLoop(
                window1, event1, values1, get_drone_action, use_brainflow
            )
        ...
        errorstr = 'EXCEPTION IN ({},\nLINE {}\n"{}"):\n\n{} {}'.format(
            filename, lineno, line.strip(), type(e), exc_obj
        )
