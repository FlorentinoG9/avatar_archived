...
<div align="center">
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/3C-SCSU/Avatar/tree/main/hardware/bci"><strong>BCI News »</strong></a>
    <br />
    <br />
...
The Avatar project follows a clean, modular architecture with clear separation of concerns:
...
│   │   ├── v5/                       # Current production GUI (Version 5)
│   │   │   ├── layouts/              # QML layout components
│   │   │   ├── modules/              # Feature modules
│   │   │   │   ├── brainwave/        # BCI brainwave monitoring
│   │   │   │   ├── brainwave-visualization/  # Visual brainwave analysis
│   │   │   │   ├── developers/       # Contributor statistics
│   │   │   │   ├── drone/            # Tello drone control interface
│   │   │   │   ├── file-shuffler/    # Data file management
│   │   │   │   ├── nao/              # NAO robot control interface
│   │   │   │   └── transfer-data/    # Data transfer utilities
│   │   │   ├── backend.py            # Main backend logic
│   │   │   └── main.qml              # Main application window
│   │   ├── assets/                   # GUI assets
│   │   │   ├── developers/           # Contributor visualizations
│   │   │   ├── icons/                # Icon resources
│   │   │   ├── images/               # Image resources
│   │   │   └── models/               # 3D models (NAO robot)
│   │   └── main.py                   # GUI entry point
│   │ 
│   ├── hardware/                     # Hardware controllers
│   │   ├── bci/                      # Brain-Computer Interface
│   │   ├── drone/                    # Tello drone controller
│   │   │   └── camera/               # Drone camera streaming
│   │   └── nao/                      # NAO robot controller & behaviors
│   │ 
...
│   │   │       ├── pytorch/          # PyTorch implementations
│   │   │       └── tensorflow/       # TensorFlow implementations
│   │   └── preprocessings/           # Data preprocessing utilities
│   │       ├── file-shuffler/        # Data shuffling tools
│   │       ├── file-unify-labels/    # Label standardization
...
│   │   └── ssl-certs/                # SSL certificates for secure communication
│   │
│   ├── kubernetes-encryption/        # Kubernetes encryption setup
│   └── server/                       # Server components & deployment
│       └── devops/                   # Docker & Nginx configurations
│
...
#### GUI Layer (`gui/`)
- **PySide6/QML-based** user interface
- Modular layout system with individual tabs
- Centralized backend for hardware and ML integration
- **Entry Point**: Run with `./run_gui.sh` or `python3 app.py`

See [gui/README.md](gui/README.md) for detailed GUI documentation.

#### Hardware Layer (`hardware/`)
- **NAO Robot**: Humanoid robot control and behaviors
- **Drone**: DJI Tello drone with camera streaming
- **BCI**: EEG headset integration for brainwave data

See [hardware/README.md](hardware/README.md) for hardware documentation.

#### Machine Learning
- **Random Forest & Deep Learning** models for brainwave classification
- Support for **PyTorch, TensorFlow, and JAX** frameworks
- Real-time and synthetic data modes
...
GUI Backend (Python)
      ↓
Hardware Controllers ← → ML Models
      ↓
Physical Devices (NAO/Drone/BCI)
```
